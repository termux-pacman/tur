...
_FLANG_COMMIT=684fa63df21e737feccbe67e9f02b3cb3aa4c2a4
TERMUX_PKG_SRCURL=https://github.com/flang-compiler/flang/archive/${_FLANG_COMMIT}.zip
TERMUX_PKG_SHA256=7b1f19fc0d76efd26c905ae3b35fa1037aff78d53819d9af21ab8ec73664406f
TERMUX_PKG_DEPENDS="libandroid-mathlib, libandroid-execinfo, libllvm-classic-flang"
...
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="-DCMAKE_INSTALL_PREFIX=$_INSTALL_PREFIX \
