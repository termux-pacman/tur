...
TERMUX_PKG_VERSION=149.0.7827.14
...
TERMUX_PKG_SHA256=635edc7f3681f3157ac4728d214e44032a22b7561b4fc10e0147a1058f670fa4
...
termux_step_post_get_source() {
	...
	local f
	for f in $(find "$TERMUX_PKG_BUILDER_DIR/../chromium-beta-host-tools/cxx-patches" -maxdepth 1 -type f -name *.patch | sort); do
