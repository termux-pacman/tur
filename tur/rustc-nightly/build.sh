...
TERMUX_PKG_VERSION="1.90.0-2025.08.01-nightly"
...
TERMUX_PKG_SHA256=35d57d5d37348fdc5541071942ed1e726573a5c20f8305e4205588471f066264
...
termux_step_configure() {
	# Use beta toolchain to build beta toolchain
